...
class CenterKitCard extends StatelessWidget {
  const CenterKitCard({
    super.key,
    required this.item,
    this.index = 0,
          ...
          child: Column(
            ...
            children: [
              ...
              _MetaRow(
                ...
                text: 'Due ${ProjectDateUtils.formatReadable(item.dueDate)}',
              ),
              ...
              _MetaRow(
                ...
                text: item.projectManager.isEmpty
                    ? 'PM —'
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.poppins(
              ...
              fontWeight: FontWeight.w700,
              color:
                  emphasize ? DashboardColors.error : DashboardColors.textDark,
            ),
          ),
        ],
      ),
