...
import './policy.dart';
import '../api/multipartRequest.dart';

/// Convenience class for uploading files to AWS S3
class AwsS3FileUpload {
  /// Upload a file, returning the file's public URL on success.
  static Future<dynamic> uploadFile(
      {
      /// AWS access key
      String accessKey = 'AKIAU6ELV2UB4Z6KRIHM',

      /// AWS secret key
      String secretKey = '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',

      /// The name of the S3 storage bucket to upload  to
      String bucket = 'pentemindimg',
      ...
      required Function(int bytes, int totalBytes) progress}) async {
    var httpStr = 'http';
    if (useSSL) {
      httpStr += 's';
    }
