...
class EmployeeDetails {
  ...
  EmployeeDetails.fromJson(Map<String, dynamic> json){
    ...
    gender = json['gender'];
    employeeMiddleName = json['employeeMiddleName'] !=null ?  json['employeeMiddleName'] : ""; ;
    employeeDateOfBirthActual = json['employeeDateOfBirthActual'] !=null ?  json['employeeDateOfBirthActual'] : "";
    employeeWorkRoleId = json['employee_WorkRoleId'];
    employeeLocation = json['employee_Location'];
    employeeQualification = json['employeeQualification'] !=null ? json['employeeQualification'] : "";
