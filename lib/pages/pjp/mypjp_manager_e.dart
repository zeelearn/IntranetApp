...
class PjpExceotionalScreen extends StatefulWidget {
  ...
  PjpExceotionalScreen(
      {Key? key,
      required this.mFilterSelection,
      required this.mPjpList,
...
class _MyPjpListState extends State<PjpExceotionalScreen>
  ...
  void initState() {
    ...
    FirebaseAnalyticsUtils()
        .sendAnalyticsEvent('PJP-CVF Attandance Approval-Exceptional');
            ...
            if (widget.isApproved &&
              ...
              for (int jIndex = 0;
                ...
                if (widget.mFilterSelection.filters[jIndex].isSelected &&
                    response.responseData[index].displayName ==
        ...
        body: SafeArea(
          child: RefreshIndicator(
            ...
            onRefresh: () async {
              ...
              IntranetServiceHandler.loadPjpExceptionalSummery(
                  employeeId, this);
            ...
            child: Column(
              children: [
                ...
                widget.isApproved || mPjpList.isEmpty || isLoading
                    ? SizedBox(
                        height: 0,
                      )
                    : Row(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text('Are you sure to approve the PJP-CVF request'),
          actions: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Utility.onConfirmationBox(
                    ...
                    'Cancel',
                    'Reject PJP-CVF',
                    'Are you sure to reject the PJP-CVF',
    ...
    if (isLoading) {
      ...
      return Flexible(
        ...
        itemBuilder: (context, index) {
          return getPjpView(mPjpList[index], index,
              mPjpList.length - 1 == index ? true : false);
        },
      ));
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                CircleAvatar(
                  backgroundImage: pjpInfo.getStatus() == PJPCVFStatus.UNKNOWN
                      ? AssetImage('assets/icons/ic_pending.png')
                      : pjpInfo.getStatus() == PJPCVFStatus.APPROVE
                          ? AssetImage('assets/icons/ic_check_mark.png')
                          : AssetImage('assets/icons/ic_cross.png'),
                ),
                SizedBox(
                  width: 10,
                ),
                ...
                pjpInfo.getStatus() == PJPCVFStatus.UNKNOWN
                    ? Checkbox(
                        checkColor: Colors.black,
                        activeColor: LightColors.kLavender,
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text(
                        pjpInfo.dateTimeIn == null || pjpInfo.dateTimeIn.isEmpty
                            ? 'NA'
                            : Utility.parsePJPDateTime(pjpInfo.dateTimeIn),
                        style: TextStyle(
                          fontSize: 12,
                          color: kPrimaryLightColor,
                          fontWeight: FontWeight.bold,
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        pjpInfo.dateTimeOut == null ||
                                pjpInfo.dateTimeOut.isEmpty
                            ? 'NA'
                            : Utility.parsePJPDateTime(pjpInfo.dateTimeOut),
                        style: TextStyle(
                          fontSize: 12,
                          color: kPrimaryLightColor,
                          fontWeight: FontWeight.bold,
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                  ...
                  //),
                  trailing: pjpInfo.getStatus() == PJPCVFStatus.UNKNOWN
                      ? Checkbox(
                          checkColor: Colors.black,
                          activeColor: LightColors.kLavender,
                          value: _isChecked[index],
  ...
  void approvePjpList(int isApprove) {
    ...
    for (int index = 0; index < mPjpList.length; index++) {
      if (_isChecked[index] == true) {
        list.add(Subroot(
            pJPId: mPjpList[index].pjPId,
            pJPCVFId: mPjpList[index].pjpcvFId,
