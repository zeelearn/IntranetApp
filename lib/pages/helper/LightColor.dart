...
class LightColor {
  ...
  static const Color primary_color = Color(0XFF26C6DA);
  static const Color primary_color_1 = Color(0XFF26C6DA);
  static const Color primarydark_color = Color(0xFF00BCD4);

  static const Color titleTextColor = const Color(0XFF26C6DA);
